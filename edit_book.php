...
// Mengambil ID postingan yang akan diedit dari parameter URL ../edit_post.php?post_id=
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="proses_post.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="content" id="content" required><?php echo $post['content']; ?>
                            </textarea>
                        </div>
